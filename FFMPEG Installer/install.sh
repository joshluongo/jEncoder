...
# Original Script From http://hunterford.me/compiling-ffmpeg-on-mac-os-x/
# Modified By Joshua Luongo

echo "FFMPEG OSX Installer"
echo " " 
...
echo "Files Unpacked"
echo "Begining Package Configuration and Installation..."
cd faac-*/
...
echo " "
echo "FFMPEG Install Script Complete!!"
